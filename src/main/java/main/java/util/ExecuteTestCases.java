...
public class ExecuteTestCases implements ITest {
	...
	public void setup() {
		...
		act.readCapturedObjectProperties();
                MainTestNG.LOGGER.info("URL : " + config.getConfigValues(curl));
		/**
	...
	private void firefoxProfile() {
		...
		profile.setPreference("browser.helperApps.neverAsk.saveToDisk",
                ...
                System.setProperty("webdriver.gecko.driver","C:\\Users\\MY PC\\Documents\\NetBeansProjects\\Selenium-Testing-Automation-Framework-master\\geckodriver.exe");
